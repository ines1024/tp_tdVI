...
X_train_ohe = hstack([X_train_ohe_obj, scaler.fit_transform(X_train_num)])
...
X_test_ohe = hstack([X_test_ohe_obj, scaler.transform(X_test_num)])
...
eval_ohe = hstack([eval_ohe_obj, scaler.transform(eval_num_sin_RowID)])
...
submission_df.to_csv("basic_model_ohe.csv", sep=",", index=False)